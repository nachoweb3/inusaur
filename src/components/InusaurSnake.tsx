      ...
      <div className="relative rounded-2xl border-2 border-green/30 bg-paper shadow-xl overflow-hidden">
        ...
        {state === "idle" && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-ink/95 backdrop-blur-sm">
            ...
            />
            <p className="font-mono text-xs tracking-[0.4em] text-green/50 uppercase">
              INUSAUR // RUN
            </p>
            <p className="mt-3 font-mono text-sm tracking-widest text-green uppercase">
              SYSTEM READY
            </p>
            <p className="mt-1 font-mono text-[0.65rem] tracking-widest text-green/40 uppercase">
              SPECIMEN SAUR-001 DETECTED
            </p>
            <button
              type="button"
              onClick={startGame}
              className="mt-8 rounded-lg border border-green/30 bg-green/10 px-8 py-3 font-mono text-xs font-bold tracking-widest text-green uppercase transition-all hover:border-green/50 hover:bg-green/20 hover:shadow-[0_0_20px_rgba(74,222,128,0.3)]"
            >
              [ START EVOLUTION ]
            </button>
            <p className="mt-4 font-mono text-[0.55rem] tracking-widest text-green/20 uppercase">
              ARROWS / WASD / TAP · SPACE TO PAUSE
            </p>
          </div>
        )}
        ...
        {state === "paused" && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-ink/90 backdrop-blur-sm">
            ...
            <p className="mt-2 font-mono text-[0.65rem] tracking-widest text-green/30 uppercase">
        ...
        {state === "dead" && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-ink/95 backdrop-blur-sm">
            ...
            />
            <p className="font-mono text-xs tracking-[0.4em] text-clay/60 uppercase">
              EVOLUTION TERMINATED
            </p>
            <p className="mt-4 font-mono text-3xl font-bold tracking-wider text-green">
              {score}
            </p>
            <p className="mt-1 font-mono text-[0.65rem] tracking-widest text-green/40 uppercase">
              FINAL SCORE
            ...
            {score >= highScore && score > 0 && (
              <p className="mt-3 flex items-center gap-2 font-mono text-xs font-bold tracking-widest text-gold uppercase">
